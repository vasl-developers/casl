...
public class MapEditFrame_AboutBox extends JDialog implements ActionListener {
	...
	private String copyright = "Copyright (c) 2000 David J. Sullivan";
	private String comments = "Map Builder";
	public MapEditFrame_AboutBox(Frame parent) {
		super(parent);
