...
public class CustomBridgeDialog extends JDialog {
  ...
  public CustomBridgeDialog(Frame frame, String title, boolean modal) {
  ...
  private void jbInit() throws Exception {
	...
	button1.setText("OK");
	button1.addActionListener(new CustomBridgeDialog_button1_actionAdapter(this));
	button2.setText("Cancel");
	gridLayout1.setHgap(4);
	button2.addActionListener(new CustomBridgeDialog_button2_actionAdapter(this));
	this.addWindowListener(new CustomBridgeDialog_this_windowAdapter(this));
  ...
  void button1_actionPerformed(ActionEvent e) {
	...
	frame.setCustomBridgeParameters(
...
class CustomBridgeDialog_button1_actionAdapter implements java.awt.event.ActionListener {
  CustomBridgeDialog adaptee;

  CustomBridgeDialog_button1_actionAdapter(CustomBridgeDialog adaptee) {
...
class CustomBridgeDialog_button2_actionAdapter implements ActionListener {
  CustomBridgeDialog adaptee;

  CustomBridgeDialog_button2_actionAdapter(CustomBridgeDialog adaptee) {
	this.adaptee = adaptee;
  }
...
class CustomBridgeDialog_this_windowAdapter extends WindowAdapter {
	CustomBridgeDialog adaptee;

	CustomBridgeDialog_this_windowAdapter(CustomBridgeDialog adaptee) {
	this.adaptee = adaptee;
	  }
